...
DEFAULT_SCHEMA = [
    ...
    "action", "src_ip", "src_port", "dst_ip", "dst_port", "protocol", "user",
    "host", "process", "url", "http_method", "status_code", "rule_name", "rule_id",
    "cloud", "raw", "_tags"
]
...
def normalize_log(data: dict) -> dict:
    ...
    normalized = {
        "@timestamp": ts,
        "tenant": data.get("tenant", os_default_tenant()),
